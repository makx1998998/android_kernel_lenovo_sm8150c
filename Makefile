...
HOSTCFLAGS  += -Wno-unused-value -Wno-unused-parameter \
		-Wno-missing-field-initializers	-Wno-compare-distinct-pointer-types
endif
...
KBUILD_CFLAGS += -mcpu=kryo -stune=kryo -mtune=kryo -fmodulo-sched -fmodulo-sched-allow-regmoves -ftree-vectorize -ftree-slp-vectorize -fvect-cost-model -fgcse-after-reload -fgcse-sm -ffast-math -fsingle-precision-constant -fvectorize -fslp-vectorize -pipe -Wno-ignored-optimization-argument -funsafe-math-optimizations -Wno-compare-distinct-pointer-types \
...
KBUILD_CFLAGS	+= -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -ffast-math -foptimize-sibling-calls \
...
KBUILD_CFLAGS += $(call cc-option, -Wno-compare-distinct-pointer-types)
